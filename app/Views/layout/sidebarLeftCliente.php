                                ...
                                <ul class="list-unstyled components">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="collapse list-unstyled" id="homeSubmenu">
                                            <li>
                                                <a href="<?= base_url('vehiculos/verRegistroVehiculo'); ?>">Registrar Vehiculo</a>
                                            </li>
                                            
                                            <li>
                                                <a href="<?= base_url('vehiculos/verEstacionar'); ?>">Estacionar</a>
                                            </li>

                                            <li>
                                                <a href="<?= base_url('vehiculos/verDesEstacionar'); ?>">DesEstacionar</a>
                                            </li>
                                        </ul>
                                    </li>

                                    <li>
                                        <a href="<?= base_url('vehiculos/verPagarEstadiasPendientes'); ?>">

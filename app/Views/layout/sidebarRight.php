                ...
                <div class="tab-content">
                    ...
                    <div id="tab-1" class="tab-pane show active">
                        <div class="pane-header">
                            ...
                            </svg> <span class="profile-user"><?= $usuarioActual['rol_nombre']; ?></span>
                    ...
                    <div id="tab-2" class="tab-pane">
                        <div class="pane-header">
                            <h3><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">

                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="apellido" class="form-control" placeholder="Apellido" value="<?= $usuario['apellido']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="fecha_de_nacimiento" class="datepicker" class="form-control calender-black" placeholder="dd/mm/aaaa" style="width:90%;" value="<?= $usuario['fecha_de_nacimiento']; ?>">
                                        </div>

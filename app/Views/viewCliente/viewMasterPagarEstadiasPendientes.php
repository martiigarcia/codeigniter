                                        ...
                                        <?php foreach ($estadiasPendientes as $e) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('cliente/PagarEstadiasPendientes/' . $e['id']); ?>" class="btn btn-outline-warning bt-sm " data-bs-toggle="tooltip" data-bs-placement="top" title="Seleccionar para pagar">

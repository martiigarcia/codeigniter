                            ...
                            <li class="list-group-item">
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        ...
                                        <p>(ingrese la patente en formato AAA-000 ó AA-000-AA ó A-000-AAA, sin espacios
                                            ni guiones)</p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <select class="form-control" id="marcaBox" name="marca"
                        ...
                        <div class="card-footer" style="color: rgb(232,74,103)">
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <p style="color: rgb(232,74,103)"> <?= session('mensajeError'); ?></p>

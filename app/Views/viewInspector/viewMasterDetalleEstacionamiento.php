            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="caption uppercase text-taffy">
                        ...
                        </svg>   Detalle del estacionamiento
                    </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Estado:  <?= $estadia['estado']==1? "ACTIVA": "FINALIZADA";?></li>
                                    <li class="list-group-item">Cantidad de horas: <?=$estadia['cantidad_horas']==null?"INDEFINIDO": $estadia['cantidad_horas']?></li>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Patente del vehiculo: <?=$estadia['vehiculo_patente']?></li>
                                    <li class="list-group-item">Marca y modelo del vehiculo: <?=$estadia['vehiculo_marca_nombre']?> <?=$estadia['vehiculo_modelo_nombre']?></li>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Nombre y apellido: <?=$estadia['nombre_usuario']?>, <?=$estadia['apellido_usuario']?></li>
